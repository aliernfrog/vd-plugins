...
`https://aliernfrog.github.io/vd-plugins/AutoNight`

<button onClick="navigator.clipboard.writeText('https://aliernfrog.github.io/vd-plugins/AutoNight')">📥 Copy install URL</button> <a href="https://github.com/aliernfrog/vd-plugins/tree/master/plugins/AutoNight"><button>🧪 Source code</button></a>
